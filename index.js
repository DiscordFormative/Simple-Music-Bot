...
client.on("ready", () => {
    ...
    console.log("Developer By iBPlus"); //If the bot is ready it sends a message in the console
    ...
    client.user.setPresence({ activity: { name: `music on ${playing}`, type: "STREAMING", url: "https://twitch.tv/ibplus01" } }) 
